            ...
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 sidebar filterbar">
                ...
                <div class="sidebar_tags">
                    ...
                    <div class="sidebar_widget categories filter-widget">
                        <div class="widget-title"><h2>Other Occasions</h2></div>
                        <div class="widget-content" style="">
                            <ul class="sidebar_categories">

                                @foreach($occasions as $occasion)
                                    <li class="level1"><a href="{{url("occasion/{$category->slug}/{$occasion->slug}")}}"
                                                          class="site-nav">{{$occasion->name}}</a></li>
                                @endforeach
                    ...
                    <div class="filters-toolbar-wrapper">
                        <div class="row">
                            ...
                            <div
                                ...
                                <span class="filters-toolbar__product-count">Showing: {{@count($occasionProducts)}} Products</span>
                            </div>
                    ...
                    <div class="grid-products grid--view-items">
                        <div class="row">
                            ...
                            @foreach($occasionProducts as $occasionProduct)
                                <?php
                                $medium_image = \App\Http\Controllers\ProductController::GetProductImage($occasionProduct->id);
                                $images = \App\Http\Controllers\ProductController::productImages($occasionProduct->id);
                                $colors = \App\Http\Controllers\ProductController::GetColors($occasionProduct->id);
                                $product_qty = \App\Http\Controllers\ProductController::GetProductQty($occasionProduct->id);
                                ?>
                                <div class="col-6 col-sm-6 col-md-4 col-lg-4 item" style="display: block;">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <div class="button-set style1">
                                            <ul>
                                                ...
                                                <li>
                                                    <!--Quick View Button-->
                                                    <button title="Quick View" data-id="{{$occasionProduct->id}}"
                                                            data-color="{{$occasionProduct->productalbum_name}}"
                                    ...
                                    <div class="product-details text-center"
                                        ...
                                        <div class="product-name">
                                            <a href="#">{{$occasionProduct->product_name}} </a>
                                        ...
                                        <div class="product-price">
                                            @if($occasionProduct->discount < 1)
                                                <span class="price">BDT {{$occasionProduct->product_price}}</span>
                                            @else
                                                <span class="price">BDT {{$occasionProduct->discount_product_price}}</span>
                                                <span
                                                    class="old-price text-danger">BDT {{$occasionProduct->product_price}}</span>
