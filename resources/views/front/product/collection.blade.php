            ...
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 sidebar filterbar">
                ...
                <div class="sidebar_tags">
                    ...
                    <div class="sidebar_widget categories filter-widget">
                        <div class="widget-title"><h2>Other Campaign</h2></div>
                        <div class="widget-content" style="">
                            <ul class="sidebar_categories">

                                @foreach($collections as $collection)
                                    <li class="level1"><a href="{{url("collection/{$category->slug}/{$collection->slug}")}}"
                                                          class="site-nav">{{$collection->name}}</a></li>
                                @endforeach
                    ...
                    <div class="filters-toolbar-wrapper">
                        <div class="row">
                            ...
                            <div
                                ...
                                <span class="filters-toolbar__product-count">Showing: {{@count($collectionProducts)}} Products</span>
                            </div>
