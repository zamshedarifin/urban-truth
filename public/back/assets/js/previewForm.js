        ...
        $(this).submit(function () {
            ...
            $(needle_cnfrm).each(function (i, val) {
                ...
                if ($(this).text().length > 0) {
                    ...
                    //var what_t= $('#'+$(this).attr('for')) ;
                    var what_t = $('[name=' + $(this).attr('for') + ']');

                    switch (what_t.attr('type')) {
                        case 'password':
            ...
            $(".form_yes").click(function () {
                var input = $("<input>").attr("type", "hidden").attr("id", "pfomdata").val("true").attr("name", "pfomdata").attr("value", "true");
